...
module Petstore
  class FakeApi
    ...
    def test_enum_query_parameters_with_http_info(opts = {})
      ...
      # query parameters
      query_params = {}
      query_params[:'enum_query_integer'] = opts[:'enum_query_integer'] if opts[:'enum_query_integer']
      ...
      # form parameters
      form_params = {}
      form_params["enum_query_string"] = opts[:'enum_query_string'] if opts[:'enum_query_string']
      form_params["enum_query_double"] = opts[:'enum_query_double'] if opts[:'enum_query_double']
