...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('map_map_of_enum')) {
        obj['map_map_of_enum'] = ApiClient.convertToType(data['map_map_of_enum'], {'String': {'String': 'String'}});
      }
  ...
  /**
   * @member {Object.<String, Object.<String, module:model/MapTest.InnerEnum>>} map_map_of_enum
   */
  exports.prototype['map_map_of_enum'] = undefined;
  /**
  ...
  /**
   * Allowed values for the <code>map_map_of_enum</code> property.
...
*/  /**
   * Allowed values for the <code>map_of_enum_string</code> property.
   * @enum {{String: String}}
   * @readonly
   */
  exports.{String: String} = {
